...
export const ualbertaCourses = [
  ...
  { name: "Introduction to Principles and Techniques of Data Science", number: "CMPUT 195" },
  { name: "Responsible Data Science and Artificial Intelligence", number: "CMPUT 200" },
  { name: "Game Artificial Intelligence", number: "CMPUT 256" },
  { name: "Introduction to Artificial Intelligence", number: "CMPUT 261" },
  { name: "Machine Learning I", number: "CMPUT 267" },
  { name: "Machine Learning II", number: "CMPUT 467" },
  { name: "Games, Puzzles, Algorithms", number: "CMPUT 355" },
  { name: "Introduction to Reinforcement Learning", number: "CMPUT 365" },
  { name: "Search and Planning in Artificial Intelligence", number: "CMPUT 366" },
  { name: "Search, Knowledge and Simulation", number: "CMPUT 455" },
  { name: "Machine Learning Essentials", number: "CMPUT 466" },
  { name: "Artificial Intelligence Capstone", number: "CMPUT 469" },
  { name: "Probabilistic Graphical Models", number: "CMPUT 463" },
  { name: "Introduction to Natural Language Processing", number: "CMPUT 461" },
